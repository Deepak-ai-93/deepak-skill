...
```
  ...
  deepak-skill — 14 agent skills crafted by Deepak 🎬
...
```bash
./install.sh              # prints the DEEPAK banner + installs all 14 skills
```
...
|---|---|
| `./install.sh` | Install **all 14 skills** into `.agents/skills/` in the current project |
