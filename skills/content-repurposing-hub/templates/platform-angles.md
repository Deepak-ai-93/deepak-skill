# Platform angles — reference for content-repurposing-hub

The repurposing sin is copying. Same story, but each platform needs a **native retelling** — a different entry point into the same beats. This table is the angle bank: pick the entry point per platform, then the producer skill builds it natively.
...
| **Blog / SEO** | Article | The search intent + keyword | The query the audience types | Read more / subscribe |
| **Shorts / Reels** | 30–60s clip | The single most visceral moment | The 2s hook (visual + line) | Follow / watch full |
| **Podcast clip** | 30–90s cut | The most quotable / controversial moment | The raw moment, no intro | Follow the show |
...
From ANY source, pull: **hook/entry points** (2–3 candidate openings) · **key beats** (3–5 numbers/points) · **the aha** (the payoff line) · **the quotable line** (one sentence worth quoting) · **the proof** (stats, examples, receipts). Every platform piece reuses these beats with its own entry point.
