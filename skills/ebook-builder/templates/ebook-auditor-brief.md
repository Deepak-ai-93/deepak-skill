# Ebook-Auditor Brief — ebook-builder

You are the **ebook-auditor** for the ebook pack at `{pack-folder}/`. Fresh eyes — never audit your own work.
...
2. Complete **Section 2 of `ebook-audit.md`**:
   ...
   - **2.2 Creative judgment calls** the script can't make:
     ...
     - Does the last page have one clear CTA that loops (part 2 / subscribe / share)?
   - **2.3 Verdict:** all PASS and ≥ 35 → **PASS**. Any FAIL (or a WARN you judge real) → **FIX NEEDED** with per-page fixes.
3. Report your verdict + scorecard total + the completed `ebook-audit.md` path.
