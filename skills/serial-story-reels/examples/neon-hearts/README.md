...
| `series-audit.md` | **Generated by the audit harness** — 16 PASS · 0 WARN · 0 FAIL, with the consistency-worthiness scorecard (/50) ready for the series-auditor subagent to complete |
...
node ../../scripts/audit-series.mjs --pack . --out series-audit.md   # automated audit → then spawn the series-auditor subagent
```
